...
merge_velo <- subset(merge_velo, cells = WhichCells(CA_dataset2))
rm(sp1_velo)
rm(sp2_velo)
rm(sp3_velo)
rm(velodata1)
...
merge_velo@reductions[["umap"]] <- CA_dataset2@reductions[["umap"]]
merge_velo@reductions[["umap"]]@cell.embeddings <-  CA_dataset2@reductions[["umap"]]@cell.embeddings[colnames(merge_velo),]
...
# CPA3 Mast_cell
## AC
# merge_velo <- RenameIdents(merge_velo,
#                          '0' = 'T_cell','1' = 'EC','2'='SMC1',
#                          '3'= 'Mod_SMC','4' ='Macrophage','5'='B_cell',
#                          '6'='SMC2','7'='Mast_cell')

## PA
merge_velo <- RenameIdents(merge_velo,
                         '0' = 'Macrophage','1' = 'T_cell1','2'='SMC1',
                         '3'= 'T_cell2','4' ='EC','5'='B_cell1',
                         '6'='Mast_cell','7'='T_cell3','8'='B_cell2')
merge_velo$'Classification1' <- Idents(merge_velo)
merge_velo@assays[["RNA"]] <- CA_dataset2@assays[["RNA"]]

saveRDS(merge_velo,"dataset2_PA_velo.RDS")
```
