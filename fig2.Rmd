...
```{r}
embedding <- FetchData(object = ds2, vars = c("UMAP_1", "UMAP_2","seurat_clusters"))
colnames(embedding) <- c("UMAP_1", "UMAP_2", "seurat_clusters")

sep = 0.3
surfaceplot("ACTA2", ds2, x_seq = seq(-2,13, sep), y_seq = seq(2,17,sep), alpha = 1, baseline = 0) %>%
