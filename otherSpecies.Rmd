...
#### 图
```{r fig.width=4, fig.height=3}
levels(Idents(mouse_carotid_stromal)) <- c("SEM cell","Fibroblast1","SMC1","SMC2","Fibroblast2","DLX SMC","Unannotated","Unannotated")
umapplot(mouse_carotid_stromal,label.size = 6,label = F) + theme(legend.text = element_blank())

p <- multi_featureplot(c("Acta2","Cnn1","Fn1","Lum","Vcam1","Ly6a","Dlx5","Dlx6","Lgals3"),mouse_carotid_stromal,labels = NA, label.size = 6)
ggsave("cir_mouse_carotid_stromal2.png",plot = p, height = 12, width = 16,device = png)
